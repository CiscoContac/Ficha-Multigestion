 ...
 if(txttelef==''){
  ...
  function AgregarNro() {
        ...
        function valorcontador(){
           ...
           window.open("http://10.165.70.246:8080/FichaClientemada.jsp?campana="+campaña.toString()+"&consultor="+consultor+"&contador="+contador+"&campa="+campa+"&manual="+manual+"&Drop="+drop+"&codcli="+codCliente,"detalle");
        }   
