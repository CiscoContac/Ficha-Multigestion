...
var consultor= f1.consultor.value;
 var contador =0;
 // window.open("http://10.165.70.246:8080/FichaCliente/detalleLlamada.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign+"&manual="+manual+"&consultor="+consultor+"&contador="+contador+"&valor=valor","detalle");
  ...
  //   f1.submit();
  window.open("http://10.165.70.246:8080/FichaCliente/Informacion_Cliente.jsp?campana="+campa.toString()+"&campa="+campaign+"&manual="+manual+"&Drop="+drop+"&codcli="+valor+"&consultor="+consultor+"&contador="+contador,"infomacion");
  window.open("http://10.165.70.246:8080/FichaCliente/Resultados.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign,"resultados");
...
//alert("cincuenta");
       ...
       //  if(manual=='null'){
        ...
        var consultor= f1.consultor.value;
                ...
                var contador =0;
                  ...
                  window.open("http://10.165.70.246:8080/FichaCliente/Informacion_Cliente.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign,"infomacion");
                  window.open("http://10.165.70.246:8080/FichaCliente/Resultados.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign,"resultados");
               // window.open("http://10.165.70.246:8080/FichaCliente/detalleLlamada.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign+"&manual="+manual+"&consultor="+consultor+"&contador="+contador+"&click=valor","detalle");
  ...
  function grabaprecod (){
    ...
    window.open("http://10.165.70.246:8080/FichaCliente/Informacion_Cliente.jsp?codcli="+valor+"&campana="+campa+"&valor="+vari+"&campa="+campaign,"infomacion"); 
    window.open("http://10.165.70.246:8080/FichaCliente/Resultados.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign,"resultados");     
   // window.open("http://10.165.70.246:8080/FichaCliente/detalleLlamada.jsp?codcli="+valor+"&campana="+campa+"&campa="+campaign+"&valor="+vari,"detalle");
  ...
  document.URL="http://10.165.70.246:8080/FichaCliente/CONSULTOR2.jsp?campana="+campana+"&campa="+campa+"&txtcodigo="+codcli+"#anotacion";   
...
//window.open("http://10.165.70.246:8080/FichaCliente/Informacion_Cliente.jsp?campana="+campaña.toString()+"&valor="+valor+"&codcli="+codcliente,"infomacion");
