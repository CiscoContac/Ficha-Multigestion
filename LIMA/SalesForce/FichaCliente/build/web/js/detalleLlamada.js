		...
		f.submit();
            ...
            function copiar(valor) {
              ...
              // alert("valor de campa click codigo "+campaign);
                ...
                window.open("http://10.165.70.246:8080/FMSalesForce/CONSULTOR2.jsp?codCliente="+codcli+"&campana="+campa+"&campa="+campaign+"&manual="+manual+"&noconsultor="+consultor,"consultor");
               //alert(codcli);
