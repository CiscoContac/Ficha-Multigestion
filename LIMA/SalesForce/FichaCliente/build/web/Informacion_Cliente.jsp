...
<iframe id="inforcabecera"  frameborder="NO"   scrolling ="no"  name="inforcabecera" src="CuerpoInformacion.jsp?campana=<%=campana%>&campa=<%=campa%>&codcli=<%=cod%>"  width="1600px"  height="895px" >
 </iframe>  
 <iframe id="inforclick"  frameborder="NO"   scrolling ="no"   name="inforclick" src="ClicikInformacion.jsp?campana=<%=campana%>&campa=<%=campa%>&codcli=<%=cod%>" width="1600px"  height="350px">
</iframe>
<input type="hidden" id="txtcodtitu" name="txtcodtitu" value="<%=cod%>">
<script language="javascript">   
   ...
   ///alert(codigo);
   if(codigo == 'null'){
        document.title='Actualización de Datos';
   }else{
   document.title='Actualización de Datos - '+ codigo;  
   }
