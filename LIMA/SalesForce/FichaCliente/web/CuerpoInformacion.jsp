...
if(estadocad.equals("Inicia manual con cliente")){%>
 ...
 <%--<body onload="redireccionarconcliente('#horaria')">--%>
  ...
  //document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"#horaria";   
...
<%}else{
   ...
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
   //document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"&valor=valor#horaria";   
 ...
 <script>
   ...
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
   //document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"&numeroclicktocholl="+num+"#numero";   
...
%>
 ...
 <%--<body onload="redireccionar('#numero')">--%>
   ...
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
   //document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"&valor=valor#numero";   
...
<%
  ...
  //alert("contacto "+campana);
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
  // document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"#contacto";   
 ...
 <% } else {  %>
  ...
  // alert("contacto "+campana);
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
  // document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"&valor=valor#contacto";   
...
if(estadocad.equals("Inicia manual con cliente")){%>
 ...
 //alert(codcli); 
// alert("telefonos2222 "+campana);
  /// document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"#Telefono";   
...
<%}else{
  ...
  // alert("telefonos "+campana);
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
   //document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"&valor=valor#Telefono";   
  ...
  // alert("telefonos "+campana);
   var codcli =document.getElementById("GenCodigo").value;
 //alert(codcli); 
 ///  document.URL="http://10.165.70.246:8080/FMSalesForce/Informacion_Cliente.jsp?campana="+campana+"&campa="+campa+"&codcli="+codcli+"#llamadas";   
