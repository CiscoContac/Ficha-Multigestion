...
document.getElementById("manual").value='llamadaManual';
 ...
 var valor="valor";
window.open("http://10.165.70.249:8084/FichaClienteSAC1/detalleLlamada.jsp?campana="+campaña.toString()+"&valor="+valor,"detalle");
f1.submit();}}
...
function modificarx(valor){
  ...
  function AgregarNro() {
        ...
        function valorcontador(){
            ...
            window.open("http://10.165.70.249:8084/FichaClienteSAC1/detalleLlamada.jsp?campana="+campaña.toString()+"&consultor="+consultor+"&contador="+contador+"&campa="+campa+"&manual="+manual+"&Drop="+drop+"&codcli="+codCliente,"detalle");
        }    
