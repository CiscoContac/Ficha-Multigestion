...
if (rd1 == false && rd2==false   )
     ...
     document.getElementById('imamodifiresul').style.display='none';
...
function cambiotipocliente(id){
      var texto;
    
    var indice = document.getElementById(id).selectedIndex;
    var textoEscogido = document.getElementById(id).options[indice].text;
  // alert(textoEscogido);
       document.getElementById('txtcbtipoCliente').value=textoEscogido;
}
function grabarcliente(){
      f1 = document.forms[0]; 
      
      var agree=confirm("¿Desea grabar cliente? ");
if (agree) { 
     f1.accionResul.value = 'grabacliente';
...
///////alert("imprime1111111111111111111111111111111111111111>"+valorr);
...
function cbcliente(valor){
   
    
    var indice = document.getElementById(valor).selectedIndex;
    if (indice==0){
        alert("Seleccionar Tipo Cliente");
        document.getElementById('selectTipoLlamada').selectedIndex = 0;
        document.getElementById('selectTipoLlamada').disabled = true;
        document.getElementById('SelectResultadoLlamada').selectedIndex = 0;
        document.getElementById('SelectResultadoLlamada').disabled = true;
        document.getElementById('cliNoContac').style.display = 'none';
        document.getElementById('cliContac').style.display = 'none';
        document.getElementById('txtrazoncontacto').value = '';
        document.getElementById('txtrazonNoConacto').value = '';
        document.getElementById('txtresultado').value = '';
        document.getElementById('txttipollamada').value = '';
    }else{
    ...
    if (indice===3 ){
        ...
        document.getElementById('regClie').style.display='block';
       //// document.getElementById('txtidagenda').value='Agendado';     
        ////// document.getElementById('dvagenda').style.display='block';
           //////alert("llegoxxxxxxxxxxxxxxxxx");
    }else{
        document.getElementById('cbrazoncontacto').selectedIndex='0';
        document.getElementById('regClie').style.display='none';
         document.getElementById('txtidagenda').value='';     
         document.getElementById('dvagenda').style.display='none';
       
    } 
    
      var textoEscogido = document.getElementById(valor).options[indice].text;
 ...
 function grabaGestion(){
         f1 = document.forms[0];
        var txt=f1.txtgrabagestion.value;
        var txtGestionEntrante=f1.txtgestionentrante.value;
        var identificador=f1.identificador.value;
       
       var checkVENTA= document.getElementById('checkVenta').checked; 
       var caja= document.getElementById('txtcja').value;
       ////alert("VENTA "+checkVENTA);
       if(checkVENTA==true  ){
           document.getElementById('txtventaU').value='VALOR'; 
       }
       
       if(checkVENTA==true && caja=='') {
           alert("Por favor Ingresar la cantidad de cajas");
       }else 
           
       if( identificador=="" ||identificador =="null" ||identificador==null    ) {
           
           alert("Ingresar c\u00f3digo de cliente");
       }else{
       
       
     if((txt===null || txt === "null" || txt==="") && (txtGestionEntrante==null  || txtGestionEntrante=="null" || txtGestionEntrante=="" ) )    {  
        
                f1.accionResul.value = 'grabaGestion';
                f1.action = 'ServletResuLLamada';
                f1.method = 'POST'; 
                f1.submit();
  ...
  alert("Ya realizo una gesti\xf3n");
  
     }      
 } 
 
 }
 function cbResultadoLlamada(valor){
    ...
    if(indice==0){
        ...
        alert("Seleccione Resultado Llamada");
        document.getElementById('cliNoContac').style.display = 'none';
        document.getElementById('cliContac').style.display = 'none';
        document.getElementById('txtrazoncontacto').value = '';
        document.getElementById('txtrazonNoConacto').value = '';   
 ...
 if (indice===1){
        ...
        document.getElementById('cliContac').style.display='block';
             document.getElementById('cliNoContac').style.display='none';
    }
    
 if (indice===2){
        document.getElementById('cliContac').style.display='none';
        document.getElementById('cliNoContac').style.display='block';
    }
       var textoEscogido = document.getElementById(valor).options[indice].text;  
       
       
     
     var indiceCliente = document.getElementById('selectTipoCliente').selectedIndex;
    
    var indiceContacto = document.getElementById('SelectResultadoLlamada').selectedIndex;
    
    
  
    
//    if(indiceCliente== 1 && indiceContacto == 1){
//         //// alert("DIVVVI"+indiceCliente + "cotnac"+indiceContacto);
//        document.getElementById('divVenta').style.display='block';
//    }else {
//        
//         document.getElementById('divVenta').style.display='none';
//    }
    document.getElementById('txtresultado').value=textoEscogido;  
    
}

function cbTipoLlamada(id){
    
    var indice = document.getElementById(id).selectedIndex;
   
    if(indice==0){
        alert("Seleccionar Tipo Llamada");
          document.getElementById('SelectResultadoLlamada').selectedIndex=0;
        document.getElementById('SelectResultadoLlamada').disabled=true;   
        document.getElementById('cliNoContac').style.display='none';
         document.getElementById('cliContac').style.display='none';
     ...
     document.getElementById('SelectResultadoLlamada').disabled=false;   
    }
    var textoEscogido = document.getElementById(id).options[indice].text;  
    
   document.getElementById('txttipollamada').value=textoEscogido; 
 ...
 function razonNoContacto(idx){
    var indice = document.getElementById(idx).selectedIndex;
   var textoEscogido = document.getElementById(idx).options[indice].text;   
  // alert("textoEscogido"+textoEscogido);
 document.getElementById('txtrazonNoConacto').value=textoEscogido;   
 }
 
 function cbclientedespues(){
   
      
var num= document.getElementById("txtclientecb").value;
////alert("num" +num);
if(num=="3"){
 document.getElementById("selectTipoCliente").selectedIndex=num;
}
...
function  copiarfecha(){
    document.getElementById('ingreso').value= document.getElementById('fechahidden').value;
}

function ventaAgente(){
    var indiceCliente = document.getElementById('selectTipoCliente').selectedIndex;
    
    var indiceContacto = document.getElementById('SelectResultadoLlamada').selectedIndex;
    
    
    if(indiceCliente== 1 && indiceContacto == 2){
        
        document.getElementById('divVenta').styke.disabled='block';
    }
