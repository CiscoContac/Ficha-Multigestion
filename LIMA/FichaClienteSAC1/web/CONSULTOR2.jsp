...
<form name="form1">   
    ...
    <iframe id="consutorcabecera"  frameborder="NO"   scrolling ="no"  name="consutorcabecera" src="frameconsultor1.jsp?campana=<%=campa%>&campa=<%=capaign%>&ANI=<%=ANI%>&Account_Number=<%=xpreparado%>&prepclicto=valor" style="height: 350px"  width="1600px"  >
 </iframe>  
...
<%}else if (codCliente != null){    
    ...
    <iframe id="consutorcabecera"  frameborder="NO"   scrolling ="no"  name="consutorcabecera" src="frameconsultor1.jsp?campana=<%=campa%>&campa=<%=capaign%>&ANI=<%=ANI%>&codCliente=<%=codCliente%>"   style="height: 350px"  width="1600px"  >
 </iframe>  
...
<iframe id="consutorcabecera"  frameborder="NO"   scrolling ="no"  name="consutorcabecera" src="frameconsultor1.jsp?campana=<%=campa%>&ANI=<%=ANI%>&campa=<%=capaign%>" style="height: 350px"   width="1600px"  >
 </iframe>  
